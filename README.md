# MegaLinter Custom Flavor: MyCustomFlavor

This custom MegaLinter aims to have an optimized Docker image size.

It is built from official MegaLinter images, but is maintained on https://github.com/mjechow/megalinter-custom-flavor by Mirko
...
- GitHub Action: On MegaLinter step in .github/workflows/mega-linter.yml, define `uses: mjechow/megalinter-custom-flavor@main`
- Docker image: Replace official MegaLinter image with `ghcr.io/mjechow/megalinter-custom-flavor/megalinter-custom-flavor:latest`
